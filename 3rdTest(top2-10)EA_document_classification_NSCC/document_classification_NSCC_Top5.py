...
for penalty in ["l2"]: #, "l1"]:
	...
	#results.append(benchmark(SVC(probability=True, class_weight='balanced',
	#								   tol=1e-3)))

	# Train SGD model
	results.append(benchmark(SGDClassifier(loss='modified_huber', alpha=.0001, n_iter=10, penalty='elasticnet')))
